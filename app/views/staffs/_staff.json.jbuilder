json.extract! staff, :id, :site_id, :firstname, :lastname, :status_type, :date_of_birth, :staff_in_out, :created_by_id ,:email, :mobile_no, :staff_id , :unit_id, :work_type, :vendor_id, :valid_from, :valid_till, :longitude, :latitude, :status, :joining_date, :created_at, :updated_at
