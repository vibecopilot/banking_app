...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post seats_url, params: { seat: { buiding_id: @seat.buiding_id, category_id: @seat.category_id, floor_id: @seat.floor_id, no: @seat.no, seat: @seat.seat, site_id: @seat.site_id, unit_id: @seat.unit_id } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { buiding_id: @seat.buiding_id, category_id: @seat.category_id, floor_id: @seat.floor_id, no: @seat.no, seat: @seat.seat, site_id: @seat.site_id, unit_id: @seat.unit_id } }
