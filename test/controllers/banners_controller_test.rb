...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { description: @banner.description, site_id: @banner.site_id, title: @banner.title } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { description: @banner.description, site_id: @banner.site_id, title: @banner.title } }
