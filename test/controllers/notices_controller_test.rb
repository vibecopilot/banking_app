...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { expiry_date: @notice.expiry_date, notice_discription: @notice.notice_discription, notice_title: @notice.notice_title, site_id: @notice.site_id } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { expiry_date: @notice.expiry_date, notice_discription: @notice.notice_discription, notice_title: @notice.notice_title, site_id: @notice.site_id } }
