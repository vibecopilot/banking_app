...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { cgst: @charge.cgst, code: @charge.code, igst: @charge.igst, name: @charge.name, sgst: @charge.sgst, site_id: @charge.site_id } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { cgst: @charge.cgst, code: @charge.code, igst: @charge.igst, name: @charge.name, sgst: @charge.sgst, site_id: @charge.site_id } }
